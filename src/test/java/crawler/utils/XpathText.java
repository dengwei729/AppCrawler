...
/**
 * Created by dengwei on 20/10/2017.
 */
public class XpathText {
    ...
    public static void main(String[] args) throws Exception {
        ...
        NodeList nodeList = (NodeList) xpath.evaluate("//*[contains(name(), 'Text') and string-length(@value)>0 and string-length(@value)<20 and @visible=\"true\"]/@value", doc, XPathConstants.NODESET);
...
//        }
    ...
    public static void init() throws Exception {
        ...
        doc = db.parse(new FileInputStream(new File("/Users/dengwei/Desktop/test.xml")));
